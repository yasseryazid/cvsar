        ...
        <form action="{{ route('staffs.store') }}" method="post" enctype="multipart/form-data"
            ...
            <div class="form-group pt-2">
                ...
                <input type="text" name="name" id="" class="form-control @error('name') is-invalid @enderror"
                    placeholder="Input fullname" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="form-group pt-2">
                ...
                <input type="text" name="job" id="" class="form-control @error('job') is-invalid @enderror"
                    placeholder="Input job" value="{{ old('job') }}">
                @error('job')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group pt-2">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="facebook_account" id=""
                        ...
                        placeholder="Input facebook_account" value="{{ old('facebook_account') }}">
                </div>
            ...
            <div class="form-group pt-2">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="twitter_account" id=""
                        ...
                        placeholder="Input twitter account url" value="{{ old('twitter_account') }}">
                </div>
            ...
            <div class="form-group pt-2">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="instagram_account" id=""
                        ...
                        placeholder="Input instagram account url" value="{{ old('instagram_account') }}">
                </div>
